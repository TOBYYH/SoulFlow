...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "SoulFlow"))
        ...
        self.actWindow.setText(_translate("MainWindow", "选择视频"))
        self.actWidget.setText(_translate("MainWindow", "使用摄像头"))
